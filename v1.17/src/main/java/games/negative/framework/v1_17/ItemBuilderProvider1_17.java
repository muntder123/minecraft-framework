package games.negative.framework.v1_17;
...
public class ItemBuilderProvider1_17 implements ItemBuilder {

    private final ItemStack is;

    public ItemBuilderProvider1_17(Material material, int amount, byte durability) {
        this.is = new ItemStack(material, amount);
    }

    public ItemBuilderProvider1_17(Material material) {
        this.is = new ItemStack(material);
    }

    public ItemBuilderProvider1_17(Material material, int amount) {
        this.is = new ItemStack(material, amount);
    }

    public ItemBuilderProvider1_17(ItemStack is) {
        this.is = is;
    }
    ...
    public short getDurability() {
        if (is.getItemMeta() instanceof Damageable) {
            return (short) ((Damageable) is.getItemMeta()).getDamage();
        } else {
            return 0;
        }
    }
    ...
    public boolean isUnbreakable() {
        return is.getItemMeta().isUnbreakable();
    }

    public @Nullable String getSkullOwner() {
        try {
            SkullMeta im = (SkullMeta) is.getItemMeta();
            return im.getOwningPlayer().getName();
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public ItemBuilder clone() {
        return new ItemBuilderProvider1_17(is);
    }
