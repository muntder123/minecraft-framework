package games.negative.framework.v1_12;
...
public class ItemBuilderProvider1_12 implements ItemBuilder {

    private final ItemStack is;

    public ItemBuilderProvider1_12(Material material, int amount, byte durability) {
        this.is = new ItemStack(material, amount, durability);
    }

    public ItemBuilderProvider1_12(Material material) {
        this.is = new ItemStack(material);
    }

    public ItemBuilderProvider1_12(Material material, int amount) {
        this.is = new ItemStack(material, amount);
    }

    public ItemBuilderProvider1_12(ItemStack is) {
        this.is = is;
    }
    ...
    public ItemBuilder clone() {
        return new ItemBuilderProvider1_12(is);
    }
