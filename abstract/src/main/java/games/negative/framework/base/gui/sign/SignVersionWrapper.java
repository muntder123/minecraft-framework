package games.negative.framework.base.gui.sign;
 ...
 * @author Rapha149
 */
public interface SignVersionWrapper {
     ...
     * @param signLoc  The location where the sign should be placed. Can be null for default. See {@link #getLocation(org.bukkit.entity.Player, int)}
