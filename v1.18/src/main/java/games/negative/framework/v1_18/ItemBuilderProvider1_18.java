package games.negative.framework.v1_18;
...
public class ItemBuilderProvider1_18 implements ItemBuilder {

    private final ItemStack is;

    public ItemBuilderProvider1_18(Material material, int amount, byte durability) {
        this.is = new ItemStack(material, amount);
    }

    public ItemBuilderProvider1_18(Material material) {
        this.is = new ItemStack(material);
    }

    public ItemBuilderProvider1_18(Material material, int amount) {
        this.is = new ItemStack(material, amount);
    }

    public ItemBuilderProvider1_18(ItemStack is) {
        this.is = is;
    }
    ...
    public ItemBuilder clone() {
        return new ItemBuilderProvider1_18(is);
    }
