package games.negative.framework.v1_10;
...
public class ItemBuilderProvider1_10 implements ItemBuilder {

    private final ItemStack is;

    public ItemBuilderProvider1_10(Material material, int amount, byte durability) {
        this.is = new ItemStack(material, amount, durability);
    }

    public ItemBuilderProvider1_10(Material material) {
        this.is = new ItemStack(material);
    }

    public ItemBuilderProvider1_10(Material material, int amount) {
        this.is = new ItemStack(material, amount);
    }

    public ItemBuilderProvider1_10(ItemStack is) {
        this.is = is;
    }
    ...
    public ItemBuilder clone() {
        return new ItemBuilderProvider1_10(is);
    }
